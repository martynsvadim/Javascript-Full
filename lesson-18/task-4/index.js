...
function saveFuncCalls(func) {
  ...
  function withMemory(...argument) {
    withMemory.callsHistory.push(argument);
...
sayHiWithMemoryBinded(); // ===> Tom // because we fixed context with bind and run functon again

sayHiWithMemory.callsHistory; // [ [] ]
